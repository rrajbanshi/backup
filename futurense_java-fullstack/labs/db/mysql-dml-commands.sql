...
INSERT INTO EMPLOYEE (NAME, AGE, GENDER, SALARY, DESIGNATION, DEPARTMENT, COUNTRY_ID) VALUES('Siddarth',45,'M',50000,'VP','Finance',5);
INSERT INTO EMPLOYEE (NAME, AGE, GENDER, SALARY, DESIGNATION, DEPARTMENT, COUNTRY_ID) VALUES('Mathes',35,'M',60000,'Function Head','HR',4);
...
LOAD DATA LOCAL INFILE '/Users/saravana/Desktop/Training/futurense_java-fullstack/labs/db/data/country.txt' INTO TABLE COUNTRY FIELDS TERMINATED BY ',';
LOAD DATA LOCAL INFILE '/Users/saravana/Desktop/Training/futurense_java-fullstack/labs/db/data/employee.txt' INTO TABLE EMPLOYEE FIELDS TERMINATED BY ',';
